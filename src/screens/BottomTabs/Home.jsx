        ...
        <View className="px-2">
          <View className="flex-row items-center justify-between px-2">
            <View className="flex-row items-center space-x-2">
              ...
              <View>
                <Text className="text-lg font-bold">371 A. Mabini Street</Text>
                <Text>Baliwag, Bulacan</Text>
              </View>
            </View>
            <Text className="text-lg font-bold underline">Change Location</Text>
          </View>
          <SafeAreaView>
            <FlatList
              numColumns={4}
          ...
          <SafeAreaView>
            <View className="flex-row items-center justify-between">
              <Text className="font-bold text-3xl">Nearby Activities</Text>
